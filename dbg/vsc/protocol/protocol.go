...
type StoppedEvent struct {
	...
	Body struct {
		...
		//
		// POSSIBLE VALUES: `step`, `breakpoint`, `exception`, `pause`, `entry`, `goto`
...
func (this *TerminateArguments) propagateFieldsToBase() {
}
...
func (this *TerminateResponse) propagateFieldsToBase() {
	this.Response.Command = this.Command
	this.Response.propagateFieldsToBase()
}
...
func (this *TerminateRequest) propagateFieldsToBase() {
	this.Request.Command = this.Command
	this.Request.Arguments = this.Arguments
	this.Request.propagateFieldsToBase()
}
...
func BaseResponse(someResponse interface{}) (baseResponse *Response) {
	...
	case *LoadedSourcesResponse:
		baseResponse = &this.Response
	case *TerminateThreadsResponse:
		baseResponse = &this.Response
	case *SetBreakpointsResponse:
		baseResponse = &this.Response
	case *SetExpressionResponse:
		baseResponse = &this.Response
...
func TryUnmarshalResponse(js string) (ptr interface{}, err error) {
	...
	case "terminateThreads":
		var val TerminateThreadsResponse
...
func TryUnmarshalRequest(js string) (ptr interface{}, err error) {
	...
	case "setExpression":
		var val SetExpressionRequest
		if err = json.Unmarshal([]byte(js), &val); err == nil {
			val.propagateFieldsToBase()
			ptr = &val
		}
	case "terminate":
		var val TerminateRequest
		if err = json.Unmarshal([]byte(js), &val); err == nil {
			val.propagateFieldsToBase()
			ptr = &val
		}
	case "terminateThreads":
		var val TerminateThreadsRequest
		if err = json.Unmarshal([]byte(js), &val); err == nil {
			val.propagateFieldsToBase()
			ptr = &val
		}
...
func HandleRequest(inRequest interface{}, initNewResponse func(*Request, *Response)) (outResponse interface{}, baseResponse *Response, handled bool, err error) {
	...
	case *TerminateRequest:
		...
		if handled = OnTerminateRequest != nil; handled {
			err = OnTerminateRequest(input, o)
			o.propagateFieldsToBase()
		}
		outResponse, baseResponse = o, &o.Response
	case *SetBreakpointsRequest:
	...
	case *SetExpressionRequest:
		...
		if handled = OnSetExpressionRequest != nil; handled {
			err = OnSetExpressionRequest(input, o)
			o.propagateFieldsToBase()
		}
		outResponse, baseResponse = o, &o.Response
	case *ExceptionInfoRequest:
	...
	case *TerminateThreadsRequest:
		...
		if handled = OnTerminateThreadsRequest != nil; handled {
			err = OnTerminateThreadsRequest(input, o)
			o.propagateFieldsToBase()
		}
		outResponse, baseResponse = o, &o.Response
	case *StackTraceRequest:
