...
//
// Package codegen'd on 2019-05-31T19:24:27+02:00 from github.com/metaleap/zentient/cmd/zentient-dbg-vsc-genprotocol/vscdbgprotocol.json with github.com/metaleap/zentient/cmd/zentient-dbg-vsc-genprotocol
package zdbgvscp
...
func BaseResponse(someResponse interface{}) (baseResponse *Response) {
	...
	case *ReverseContinueResponse:
		baseResponse = &me.Response
	case *DataBreakpointInfoResponse:
		baseResponse = &me.Response
	...
	case *PauseResponse:
		baseResponse = &me.Response
	case *SetDataBreakpointsResponse:
		baseResponse = &me.Response
...
func TryUnmarshalRequest(js string) (ptr interface{}, err error) {
	...
	case "dataBreakpointInfo":
		var val DataBreakpointInfoRequest
		if err = json.Unmarshal([]byte(js), &val); err == nil {
			val.propagateFieldsToBase()
			ptr = &val
		}
	...
	case "setDataBreakpoints":
		var val SetDataBreakpointsRequest
		if err = json.Unmarshal([]byte(js), &val); err == nil {
			val.propagateFieldsToBase()
			ptr = &val
		}
...
func TryUnmarshalResponse(js string) (ptr interface{}, err error) {
	...
	case "setDataBreakpoints":
		var val SetDataBreakpointsResponse
		if err = json.Unmarshal([]byte(js), &val); err == nil {
			val.propagateFieldsToBase()
			ptr = &val
		}
	...
	case "dataBreakpointInfo":
		var val DataBreakpointInfoResponse
		if err = json.Unmarshal([]byte(js), &val); err == nil {
			val.propagateFieldsToBase()
			ptr = &val
		}
...
func HandleRequest(inRequest interface{}, initNewResponse func(*Request, *Response)) (outResponse interface{}, baseResponse *Response, handled bool, err error) {
	...
	case *DisassembleRequest:
		...
		if handled = OnDisassembleRequest != nil; handled {
			err = OnDisassembleRequest(input, o)
			o.propagateFieldsToBase()
		}
	...
	case *DataBreakpointInfoRequest:
		...
		if handled = OnDataBreakpointInfoRequest != nil; handled {
			err = OnDataBreakpointInfoRequest(input, o)
			o.propagateFieldsToBase()
		}
		outResponse, baseResponse = o, &o.Response
	case *SetFunctionBreakpointsRequest:
	...
	case *ReadMemoryRequest:
		...
		if handled = OnReadMemoryRequest != nil; handled {
			err = OnReadMemoryRequest(input, o)
			o.propagateFieldsToBase()
		}
		outResponse, baseResponse = o, &o.Response
	case *ScopesRequest:
	...
	case *SetDataBreakpointsRequest:
		...
		if handled = OnSetDataBreakpointsRequest != nil; handled {
			err = OnSetDataBreakpointsRequest(input, o)
			o.propagateFieldsToBase()
		}
		outResponse, baseResponse = o, &o.Response
	case *GotoTargetsRequest:
