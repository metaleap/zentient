...
func TryUnmarshalProtocolMessage (js string) (ptr interface{}, err error) {
	...
	case "response":  var val Response  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
...
func TryUnmarshalEvent (js string) (ptr interface{}, err error) {
	...
	case "exited":  var val ExitedEvent  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "module":  var val ModuleEvent  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "breakpoint":  var val BreakpointEvent  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "continued":  var val ContinuedEvent  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "thread":  var val ThreadEvent  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "terminated":  var val TerminatedEvent  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "output":  var val OutputEvent  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "initialized":  var val InitializedEvent  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "stopped":  var val StoppedEvent  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
...
func TryUnmarshalRequest (js string) (ptr interface{}, err error) {
	...
	case "setVariable":  var val SetVariableRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "stackTrace":  var val StackTraceRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "scopes":  var val ScopesRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "modules":  var val ModulesRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "setFunctionBreakpoints":  var val SetFunctionBreakpointsRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "continue":  var val ContinueRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "restartFrame":  var val RestartFrameRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "next":  var val NextRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "goto":  var val GotoRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "stepOut":  var val StepOutRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "exceptionInfo":  var val ExceptionInfoRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "setBreakpoints":  var val SetBreakpointsRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "configurationDone":  var val ConfigurationDoneRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "attach":  var val AttachRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "runInTerminal":  var val RunInTerminalRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "launch":  var val LaunchRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "completions":  var val CompletionsRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "pause":  var val PauseRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "reverseContinue":  var val ReverseContinueRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "stepInTargets":  var val StepInTargetsRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "stepBack":  var val StepBackRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "disconnect":  var val DisconnectRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "initialize":  var val InitializeRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "variables":  var val VariablesRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "threads":  var val ThreadsRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "evaluate":  var val EvaluateRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "stepIn":  var val StepInRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "restart":  var val RestartRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "setExceptionBreakpoints":  var val SetExceptionBreakpointsRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "source":  var val SourceRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	case "gotoTargets":  var val GotoTargetsRequest  ;  if err = json.Unmarshal([]byte(js), &val); err==nil { ptr = &val }
	default: err = errors.New("Request: encountered unknown JSON value for command: " + command_of_Request)
	}
	return
}

// Called by `HandleRequest` when unmarshaling `SetVariableRequest` to populate the given `SetVariableResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnSetVariableRequest func(*SetVariableRequest, *SetVariableResponse)error

// Called by `HandleRequest` when unmarshaling `StepOutRequest` to populate the given `StepOutResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnStepOutRequest func(*StepOutRequest, *StepOutResponse)error

// Called by `HandleRequest` when unmarshaling `LaunchRequest` to populate the given `LaunchResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnLaunchRequest func(*LaunchRequest, *LaunchResponse)error

// Called by `HandleRequest` when unmarshaling `ThreadsRequest` to populate the given `ThreadsResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnThreadsRequest func(*ThreadsRequest, *ThreadsResponse)error

// Called by `HandleRequest` when unmarshaling `StepInRequest` to populate the given `StepInResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnStepInRequest func(*StepInRequest, *StepInResponse)error

// Called by `HandleRequest` when unmarshaling `SetExceptionBreakpointsRequest` to populate the given `SetExceptionBreakpointsResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnSetExceptionBreakpointsRequest func(*SetExceptionBreakpointsRequest, *SetExceptionBreakpointsResponse)error

// Called by `HandleRequest` when unmarshaling `ReverseContinueRequest` to populate the given `ReverseContinueResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnReverseContinueRequest func(*ReverseContinueRequest, *ReverseContinueResponse)error

// Called by `HandleRequest` when unmarshaling `AttachRequest` to populate the given `AttachResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnAttachRequest func(*AttachRequest, *AttachResponse)error

// Called by `HandleRequest` when unmarshaling `ScopesRequest` to populate the given `ScopesResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnScopesRequest func(*ScopesRequest, *ScopesResponse)error

// Called by `HandleRequest` when unmarshaling `CompletionsRequest` to populate the given `CompletionsResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnCompletionsRequest func(*CompletionsRequest, *CompletionsResponse)error

// Called by `HandleRequest` when unmarshaling `ExceptionInfoRequest` to populate the given `ExceptionInfoResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnExceptionInfoRequest func(*ExceptionInfoRequest, *ExceptionInfoResponse)error

// Called by `HandleRequest` when unmarshaling `SetFunctionBreakpointsRequest` to populate the given `SetFunctionBreakpointsResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnSetFunctionBreakpointsRequest func(*SetFunctionBreakpointsRequest, *SetFunctionBreakpointsResponse)error

// Called by `HandleRequest` when unmarshaling `GotoTargetsRequest` to populate the given `GotoTargetsResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnGotoTargetsRequest func(*GotoTargetsRequest, *GotoTargetsResponse)error

// Called by `HandleRequest` when unmarshaling `RestartRequest` to populate the given `RestartResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnRestartRequest func(*RestartRequest, *RestartResponse)error

// Called by `HandleRequest` when unmarshaling `StackTraceRequest` to populate the given `StackTraceResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnStackTraceRequest func(*StackTraceRequest, *StackTraceResponse)error

// Called by `HandleRequest` when unmarshaling `ConfigurationDoneRequest` to populate the given `ConfigurationDoneResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnConfigurationDoneRequest func(*ConfigurationDoneRequest, *ConfigurationDoneResponse)error

// Called by `HandleRequest` when unmarshaling `DisconnectRequest` to populate the given `DisconnectResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnDisconnectRequest func(*DisconnectRequest, *DisconnectResponse)error

// Called by `HandleRequest` when unmarshaling `VariablesRequest` to populate the given `VariablesResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnVariablesRequest func(*VariablesRequest, *VariablesResponse)error

// Called by `HandleRequest` when unmarshaling `StepInTargetsRequest` to populate the given `StepInTargetsResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnStepInTargetsRequest func(*StepInTargetsRequest, *StepInTargetsResponse)error

// Called by `HandleRequest` when unmarshaling `RestartFrameRequest` to populate the given `RestartFrameResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnRestartFrameRequest func(*RestartFrameRequest, *RestartFrameResponse)error

// Called by `HandleRequest` when unmarshaling `ModulesRequest` to populate the given `ModulesResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnModulesRequest func(*ModulesRequest, *ModulesResponse)error

// Called by `HandleRequest` when unmarshaling `PauseRequest` to populate the given `PauseResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnPauseRequest func(*PauseRequest, *PauseResponse)error

// Called by `HandleRequest` when unmarshaling `ContinueRequest` to populate the given `ContinueResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnContinueRequest func(*ContinueRequest, *ContinueResponse)error

// Called by `HandleRequest` when unmarshaling `SetBreakpointsRequest` to populate the given `SetBreakpointsResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnSetBreakpointsRequest func(*SetBreakpointsRequest, *SetBreakpointsResponse)error

// Called by `HandleRequest` when unmarshaling `SourceRequest` to populate the given `SourceResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnSourceRequest func(*SourceRequest, *SourceResponse)error

// Called by `HandleRequest` when unmarshaling `RunInTerminalRequest` to populate the given `RunInTerminalResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnRunInTerminalRequest func(*RunInTerminalRequest, *RunInTerminalResponse)error

// Called by `HandleRequest` when unmarshaling `EvaluateRequest` to populate the given `EvaluateResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnEvaluateRequest func(*EvaluateRequest, *EvaluateResponse)error

// Called by `HandleRequest` when unmarshaling `NextRequest` to populate the given `NextResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnNextRequest func(*NextRequest, *NextResponse)error

// Called by `HandleRequest` when unmarshaling `InitializeRequest` to populate the given `InitializeResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnInitializeRequest func(*InitializeRequest, *InitializeResponse)error

// Called by `HandleRequest` when unmarshaling `StepBackRequest` to populate the given `StepBackResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnStepBackRequest func(*StepBackRequest, *StepBackResponse)error

// Called by `HandleRequest` when unmarshaling `GotoRequest` to populate the given `GotoResponse` that it'll then return a pointer to (or discard and return `nil` in case this handler returns an `error`).
var OnGotoRequest func(*GotoRequest, *GotoResponse)error

// If a type-switch on `inRequest` succeeds, `outResponse` points to a `Response`-based `struct` value containing the `Response` returned by the specified `makeNewResponse` constructor and further populated by the `OnFooRequest` handler corresponding to the concrete type of `inRequest` (if any). The only `err` returned, if any, is that returned by the specialized `OnFooRequest` handler.
func HandleRequest (inRequest interface{}, makeNewResponse func(*Request)Response) (outResponse interface{}, baseResponse *Response, err error) {
	switch input := inRequest.(type) {
	case *CompletionsRequest: output := CompletionsResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnCompletionsRequest!=nil { err = OnCompletionsRequest(input, &output) }; outResponse = &output
	case *ExceptionInfoRequest: output := ExceptionInfoResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnExceptionInfoRequest!=nil { err = OnExceptionInfoRequest(input, &output) }; outResponse = &output
	case *SetFunctionBreakpointsRequest: output := SetFunctionBreakpointsResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnSetFunctionBreakpointsRequest!=nil { err = OnSetFunctionBreakpointsRequest(input, &output) }; outResponse = &output
	case *GotoTargetsRequest: output := GotoTargetsResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnGotoTargetsRequest!=nil { err = OnGotoTargetsRequest(input, &output) }; outResponse = &output
	case *RestartRequest: output := RestartResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnRestartRequest!=nil { err = OnRestartRequest(input, &output) }; outResponse = &output
	case *StackTraceRequest: output := StackTraceResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnStackTraceRequest!=nil { err = OnStackTraceRequest(input, &output) }; outResponse = &output
	case *ConfigurationDoneRequest: output := ConfigurationDoneResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnConfigurationDoneRequest!=nil { err = OnConfigurationDoneRequest(input, &output) }; outResponse = &output
	case *DisconnectRequest: output := DisconnectResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnDisconnectRequest!=nil { err = OnDisconnectRequest(input, &output) }; outResponse = &output
	case *VariablesRequest: output := VariablesResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnVariablesRequest!=nil { err = OnVariablesRequest(input, &output) }; outResponse = &output
	case *StepInTargetsRequest: output := StepInTargetsResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnStepInTargetsRequest!=nil { err = OnStepInTargetsRequest(input, &output) }; outResponse = &output
	case *RestartFrameRequest: output := RestartFrameResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnRestartFrameRequest!=nil { err = OnRestartFrameRequest(input, &output) }; outResponse = &output
	case *ModulesRequest: output := ModulesResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnModulesRequest!=nil { err = OnModulesRequest(input, &output) }; outResponse = &output
	case *PauseRequest: output := PauseResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnPauseRequest!=nil { err = OnPauseRequest(input, &output) }; outResponse = &output
	case *ContinueRequest: output := ContinueResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnContinueRequest!=nil { err = OnContinueRequest(input, &output) }; outResponse = &output
	case *SetBreakpointsRequest: output := SetBreakpointsResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnSetBreakpointsRequest!=nil { err = OnSetBreakpointsRequest(input, &output) }; outResponse = &output
	case *SourceRequest: output := SourceResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnSourceRequest!=nil { err = OnSourceRequest(input, &output) }; outResponse = &output
	case *RunInTerminalRequest: output := RunInTerminalResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnRunInTerminalRequest!=nil { err = OnRunInTerminalRequest(input, &output) }; outResponse = &output
	case *EvaluateRequest: output := EvaluateResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnEvaluateRequest!=nil { err = OnEvaluateRequest(input, &output) }; outResponse = &output
	case *NextRequest: output := NextResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnNextRequest!=nil { err = OnNextRequest(input, &output) }; outResponse = &output
	case *InitializeRequest: output := InitializeResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnInitializeRequest!=nil { err = OnInitializeRequest(input, &output) }; outResponse = &output
	case *StepBackRequest: output := StepBackResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnStepBackRequest!=nil { err = OnStepBackRequest(input, &output) }; outResponse = &output
	case *GotoRequest: output := GotoResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnGotoRequest!=nil { err = OnGotoRequest(input, &output) }; outResponse = &output
	case *SetVariableRequest: output := SetVariableResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnSetVariableRequest!=nil { err = OnSetVariableRequest(input, &output) }; outResponse = &output
	case *StepOutRequest: output := StepOutResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnStepOutRequest!=nil { err = OnStepOutRequest(input, &output) }; outResponse = &output
	case *ScopesRequest: output := ScopesResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnScopesRequest!=nil { err = OnScopesRequest(input, &output) }; outResponse = &output
	case *LaunchRequest: output := LaunchResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnLaunchRequest!=nil { err = OnLaunchRequest(input, &output) }; outResponse = &output
	case *ThreadsRequest: output := ThreadsResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnThreadsRequest!=nil { err = OnThreadsRequest(input, &output) }; outResponse = &output
	case *StepInRequest: output := StepInResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnStepInRequest!=nil { err = OnStepInRequest(input, &output) }; outResponse = &output
	case *SetExceptionBreakpointsRequest: output := SetExceptionBreakpointsResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnSetExceptionBreakpointsRequest!=nil { err = OnSetExceptionBreakpointsRequest(input, &output) }; outResponse = &output
	case *ReverseContinueRequest: output := ReverseContinueResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnReverseContinueRequest!=nil { err = OnReverseContinueRequest(input, &output) }; outResponse = &output
	case *AttachRequest: output := AttachResponse{ Response: makeNewResponse(&input.Request) }; baseResponse = &output.Response; if OnAttachRequest!=nil { err = OnAttachRequest(input, &output) }; outResponse = &output
	}
	return
}
