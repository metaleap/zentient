...
func (me *IpcResp) preview_MarshalJSON() (r []byte, err error) {
	...
	if me == nil {
		...
		if len(me.SrcActions) != 0 {
			...
			r = append(r, 91)
			ai22 := len(r)
			for i21 := range me.SrcActions {
				{
					r = append(r, 44)
					var e error
					var sl []byte
					sl, e = me.SrcActions[i21].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
...
func (me *Diags) preview_MarshalJSON() (r []byte, err error) {
	...
	if me == nil {
		...
		if nil == me.FixUps {
			...
			r = append(r, 91)
			ai10 := len(r)
			for i9 := range me.FixUps {
				if nil != me.FixUps[i9] {
					{
						r = append(r, 44)
						var e error
						var sl []byte
						sl, e = me.FixUps[i9].preview_MarshalJSON()
						if e == nil {
							r = append(r, sl...)
						} else {
							err = e
...
func (me *Extras) preview_MarshalJSON() (r []byte, err error) {
	...
	if me == nil {
		...
		if len(me.SrcIntels.InfoTips) != 0 {
			...
			r = append(r, 91)
			ai4 := len(r)
			for i3 := range me.SrcIntels.InfoTips {
				{
					r = append(r, 44)
					var e error
					var sl []byte
					sl, e = me.SrcIntels.InfoTips[i3].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
		...
		if nil == me.Items {
			...
			r = append(r, 91)
			ai18 := len(r)
			for i17 := range me.Items {
				if nil != me.Items[i17] {
					{
						r = append(r, 44)
						var e error
						var sl []byte
						sl, e = me.Items[i17].preview_MarshalJSON()
						if e == nil {
							r = append(r, sl...)
						} else {
							err = e
...
func (me *DiagFixUps) preview_MarshalJSON() (r []byte, err error) {
	...
	if me == nil {
		...
		if nil == me.Desc {
			...
			r = append(r, 123)
			mi3 := len(r)
			for mk4, mv5 := range me.Desc {
				sl, e := __gent__jsonMarshal_s_string(mv5)
				if e == nil {
					{
						r = append(r, 44)
						r = append(r, pkg__strconv.Quote(mk4)...)
						r = append(r, 58)
					}
					r = append(r, sl...)
				} else {
		...
		if nil == me.Dropped {
			...
			r = append(r, 91)
			ai13 := len(r)
			for i12 := range me.Dropped {
				{
					r = append(r, 44)
					var e error
					var sl []byte
					sl, e = me.Dropped[i12].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
...
func (me *DiagItem) preview_MarshalJSON() (r []byte, err error) {
	...
	if me == nil {
			...
			for i9 := range me.Rel {
				{
					...
					var e error
					var sl []byte
					sl, e = me.Rel[i9].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
			...
			for i17 := range me.SrcActions {
				{
					...
					var e error
					var sl []byte
					sl, e = me.SrcActions[i17].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
		...
		if len(me.Tags) != 0 {
			...
			r = append(r, 91)
			ai26 := len(r)
			for i25 := range me.Tags {
				{
					r = append(r, 44)
					r = append(r, pkg__strconv.FormatInt((int64)(me.Tags[i25]), 10)...)
				}
			}
			r = append(r, 93)
			if r[ai26] == 44 {
				r = append(r[:ai26], r[(ai26+1):]...)
			}
		}
		r = append(r, 125)
		if r[si2] == 44 {
			...
			if nil != me[i2] {
				{
					...
					var e error
					var sl []byte
					sl, e = me[i2].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
...
func (me *EditorAction) preview_MarshalJSON() (r []byte, err error) {
	...
	if me == nil {
		...
		if len(me.Arguments) != 0 {
			...
			r = append(r, 91)
			ai4 := len(r)
			for i3 := range me.Arguments {
				sl, e := __gent__jsonMarshal_interface____(me.Arguments[i3])
				if e == nil {
					r = append(r, 44)
					r = append(r, sl...)
				} else {
			...
			for i3 := range me.InfoTips {
				{
					...
					var e error
					var sl []byte
					sl, e = me.InfoTips[i3].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
...
func (me *SrcIntelSigInfo) preview_MarshalJSON() (r []byte, err error) {
	...
	if me == nil {
		...
		if nil == me.Parameters {
			...
			r = append(r, 91)
			ai10 := len(r)
			for i9 := range me.Parameters {
				{
					r = append(r, 44)
					var e error
					var sl []byte
					sl, e = me.Parameters[i9].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
	...
	if nil == v {
	...
	} else {
		{
			...
			if ok {
				...
				v7, ok8 := v.(map[string]interface{})
				if ok8 {
					sl, e = __gent__jsonMarshal_mapsstring_interface____(v7)
				} else {
					v5, ok6 := v.([]string)
					if ok6 {
						sl, e = __gent__jsonMarshal_s_string(v5)
					} else {
						v3, ok4 := v.(string)
						if ok4 {
							sl, e = __gent__jsonMarshal_string(v3)
						} else {
...
func __gent__jsonMarshal_s_string(v []string) (r []byte, err error) {
	if nil == v {
		...
		for i9 := range v {
			{
				r = append(r, 44)
				r = append(r, pkg__strconv.Quote(v[i9])...)
			}
		}
		r = append(r, 93)
		if r[ai10] == 44 {
...
func __gent__jsonMarshal_mapsstring_interface____(v map[string]interface{}) (r []byte, err error) {
	if nil == v {
		...
		r = append(r, 123)
		mi11 := len(r)
		for mk12, mv13 := range v {
			sl, e := __gent__jsonMarshal_interface____(mv13)
			if e == nil {
				{
					r = append(r, 44)
					r = append(r, pkg__strconv.Quote(mk12)...)
					r = append(r, 58)
				}
				r = append(r, sl...)
			} else {
