...
func (me *DiagItem) preview_MarshalJSON() (r []byte, err error) {
	...
	if me == nil {
		...
		if len(me.SrcActions) != 0 {
			...
			r = append(r, 91)
			ai190 := len(r)
			for i189 := range me.SrcActions {
				{
					r = append(r, 44)
					var e error
					var sl []byte
					sl, e = me.SrcActions[i189].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
		...
		if len(me.Tags) != 0 {
			...
			r = append(r, 91)
			ai198 := len(r)
			for i197 := range me.Tags {
				{
					r = append(r, 44)
					r = append(r, pkg__strconv.FormatInt((int64)(me.Tags[i197]), 10)...)
				}
			}
			r = append(r, 93)
			if r[ai198] == 44 {
			...
			if nil != me[i199] {
				{
					...
					var e error
					var sl []byte
					sl, e = me[i199].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
...
func (me DiagItemsBy) preview_MarshalJSON() (r []byte, err error) {
	...
	if nil == me {
		...
		r = append(r, 123)
		mi207 := len(r)
		for mk208, mv209 := range me {
			{
				{
					r = append(r, 44)
					r = append(r, pkg__strconv.Quote(mk208)...)
					r = append(r, 58)
				}
				var e error
				var sl []byte
				sl, e = mv209.preview_MarshalJSON()
				if e == nil {
					r = append(r, sl...)
				} else {
					err = e
...
func (me *EditorAction) preview_MarshalJSON() (r []byte, err error) {
	...
	if me == nil {
		...
		if len(me.Arguments) != 0 {
			...
			r = append(r, 91)
			ai218 := len(r)
			for i217 := range me.Arguments {
				sl, e := __gent__jsonMarshal_interface____(me.Arguments[i217])
				if e == nil {
					r = append(r, 44)
					r = append(r, sl...)
				} else {
			...
			r = append(r, 93)
			if r[ai218] == 44 {
				r = append(r[:ai218], r[(ai218+1):]...)
			}
		}
		r = append(r, 125)
		if r[si216] == 44 {
			r = append(r[:si216], r[(si216+1):]...)
		}
	}
	return
}
			...
			if nil != me[i227] {
				{
					...
					var e error
					var sl []byte
					sl, e = me[i227].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
			...
			if nil != me[i252] {
				{
					...
					var e error
					var sl []byte
					sl, e = me[i252].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
...
func (me *SrcIntels) preview_MarshalJSON() (r []byte, err error) {
	...
	if me == nil {
		...
		if len(me.InfoTips) != 0 {
			...
			r = append(r, 91)
			ai262 := len(r)
			for i261 := range me.InfoTips {
				{
					r = append(r, 44)
					var e error
					var sl []byte
					sl, e = me.InfoTips[i261].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
...
func (me *SrcIntelSigHelp) preview_MarshalJSON() (r []byte, err error) {
	...
	if me == nil {
		...
		if len(me.Signatures) != 0 {
			...
			r = append(r, 91)
			ai278 := len(r)
			for i277 := range me.Signatures {
				{
					r = append(r, 44)
					var e error
					var sl []byte
					sl, e = me.Signatures[i277].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
...
func (me *SrcIntelSigInfo) preview_MarshalJSON() (r []byte, err error) {
	...
	if me == nil {
		...
		if nil == me.Parameters {
			...
			r = append(r, 91)
			ai293 := len(r)
			for i292 := range me.Parameters {
				{
					r = append(r, 44)
					var e error
					var sl []byte
					sl, e = me.Parameters[i292].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
			...
			r = append(r, 93)
			if r[ai293] == 44 {
				r = append(r[:ai293], r[(ai293+1):]...)
			}
		}
		r = append(r, 125)
		if r[si285] == 44 {
			r = append(r[:si285], r[(si285+1):]...)
		}
	}
	return
}
			...
			if nil != me[i307] {
				{
					...
					var e error
					var sl []byte
					sl, e = me[i307].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
			...
			if nil != me[i341] {
				{
					...
					var e error
					var sl []byte
					sl, e = me[i341].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
		...
		for i356 := range me {
			{
				...
				var e error
				var sl []byte
				sl, e = me[i356].preview_MarshalJSON()
				if e == nil {
					r = append(r, sl...)
				} else {
					err = e
