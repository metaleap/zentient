			...
			for i2 := range me.SrcActions {
				{
					...
					var e error
					var sl []byte
					sl, e = me.SrcActions[i2].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
...
func (me *Diags) preview_MarshalJSON() (r []byte, err error) {
	...
	if me == nil {
		...
		if nil == me.FixUps {
			...
			r = append(r, 91)
			ai6 := len(r)
			for i5 := range me.FixUps {
				if nil != me.FixUps[i5] {
					{
						r = append(r, 44)
						var e error
						var sl []byte
						sl, e = me.FixUps[i5].preview_MarshalJSON()
						if e == nil {
							r = append(r, sl...)
						} else {
							err = e
...
func (me *Extras) preview_MarshalJSON() (r []byte, err error) {
	...
	if me == nil {
		...
		if len(me.SrcIntels.InfoTips) != 0 {
			...
			r = append(r, 91)
			ai9 := len(r)
			for i8 := range me.SrcIntels.InfoTips {
				{
					r = append(r, 44)
					var e error
					var sl []byte
					sl, e = me.SrcIntels.InfoTips[i8].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
		...
		if nil == me.Items {
			...
			r = append(r, 91)
			ai11 := len(r)
			for i10 := range me.Items {
				if nil != me.Items[i10] {
					{
						r = append(r, 44)
						var e error
						var sl []byte
						sl, e = me.Items[i10].preview_MarshalJSON()
						if e == nil {
							r = append(r, sl...)
						} else {
							err = e
		...
		if len(me.Warns) != 0 {
			...
			r = append(r, 91)
			ai13 := len(r)
			for i12 := range me.Warns {
				{
					r = append(r, 44)
					r = append(r, pkg__strconv.Quote(me.Warns[i12])...)
				}
			}
			r = append(r, 93)
			if r[ai13] == 44 {
				r = append(r[:ai13], r[(ai13+1):]...)
			}
		}
		if len(me.Desc) != 0 {
			r = append(r, ",\"Desc\":"...)
...
func (me *SrcIntel) preview_MarshalJSON() (r []byte, err error) {
	...
	if me == nil {
		...
		if len(me.SrcIntels.InfoTips) != 0 {
			...
			r = append(r, 91)
			ai17 := len(r)
			for i16 := range me.SrcIntels.InfoTips {
				{
					r = append(r, 44)
					var e error
					var sl []byte
					sl, e = me.SrcIntels.InfoTips[i16].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
		...
		if len(me.Anns) != 0 {
			...
			r = append(r, 91)
			ai19 := len(r)
			for i18 := range me.Anns {
				if nil != me.Anns[i18] {
					{
						r = append(r, 44)
						var e error
						var sl []byte
						sl, e = me.Anns[i18].preview_MarshalJSON()
						if e == nil {
							r = append(r, sl...)
						} else {
							err = e
			...
			r = append(r, 93)
			if r[ai19] == 44 {
				r = append(r[:ai19], r[(ai19+1):]...)
			}
		}
		r = append(r, 125)
		if r[si15] == 44 {
			r = append(r[:si15], r[(si15+1):]...)
		}
	}
	return
}
...
func (me *DiagFixUps) preview_MarshalJSON() (r []byte, err error) {
	...
	if me == nil {
		...
		if nil == me.Desc {
			...
			r = append(r, 123)
			mi23 := len(r)
			for mk24, mv25 := range me.Desc {
				if nil == mv25 {
					{
						r = append(r, 44)
						r = append(r, pkg__strconv.Quote(mk24)...)
						r = append(r, 58)
					}
					r = append(r, "null"...)
				} else {
					...
					for i26 := range mv25 {
						{
							r = append(r, 44)
							r = append(r, pkg__strconv.Quote(mv25[i26])...)
						}
					}
					r = append(r, 93)
					if r[ai27] == 44 {
		...
		if nil == me.Dropped {
			...
			r = append(r, 91)
			ai29 := len(r)
			for i28 := range me.Dropped {
				{
					r = append(r, 44)
					var e error
					var sl []byte
					sl, e = me.Dropped[i28].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
			...
			r = append(r, 93)
			if r[ai29] == 44 {
				r = append(r[:ai29], r[(ai29+1):]...)
			}
		}
		r = append(r, 125)
		if r[si22] == 44 {
			r = append(r[:si22], r[(si22+1):]...)
		}
	}
	return
}
...
func (me *DiagItem) preview_MarshalJSON() (r []byte, err error) {
	...
	if me == nil {
			...
			for i31 := range me.SrcActions {
				{
					...
					var e error
					var sl []byte
					sl, e = me.SrcActions[i31].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
		...
		if len(me.Tags) != 0 {
			...
			r = append(r, 91)
			ai34 := len(r)
			for i33 := range me.Tags {
				{
					r = append(r, 44)
					r = append(r, pkg__strconv.FormatInt((int64)(me.Tags[i33]), 10)...)
				}
			}
			r = append(r, 93)
			if r[ai34] == 44 {
				r = append(r[:ai34], r[(ai34+1):]...)
			}
		}
		r = append(r, 125)
		if r[si30] == 44 {
			r = append(r[:si30], r[(si30+1):]...)
		}
	}
	return
}
			...
			if nil != me[i35] {
				{
					...
					var e error
					var sl []byte
					sl, e = me[i35].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
...
func (me DiagItemsBy) preview_MarshalJSON() (r []byte, err error) {
	...
	if nil == me {
		...
		r = append(r, 123)
		mi37 := len(r)
		for mk38, mv39 := range me {
			{
				{
					r = append(r, 44)
					r = append(r, pkg__strconv.Quote(mk38)...)
					r = append(r, 58)
				}
				var e error
				var sl []byte
				sl, e = mv39.preview_MarshalJSON()
				if e == nil {
					r = append(r, sl...)
				} else {
					err = e
...
func (me *EditorAction) preview_MarshalJSON() (r []byte, err error) {
	...
	if me == nil {
		...
		if len(me.Arguments) != 0 {
			...
			r = append(r, 91)
			ai42 := len(r)
			for i41 := range me.Arguments {
				{
					r = append(r, 44)
					var e error
					var sl []byte
					j, _ := me.Arguments[i41].(pkg__encoding_json.Marshaler)
					if j != nil {
						sl, e = j.MarshalJSON()
					} else {
						sl, e = pkg__encoding_json.Marshal(me.Arguments[i41])
					}
					if e == nil {
						r = append(r, sl...)
					} else {
			...
			r = append(r, 93)
			if r[ai42] == 44 {
				r = append(r[:ai42], r[(ai42+1):]...)
			}
		}
		r = append(r, 125)
		if r[si40] == 44 {
			r = append(r[:si40], r[(si40+1):]...)
		}
	}
	return
}
			...
			if nil != me[i45] {
				{
					...
					var e error
					var sl []byte
					sl, e = me[i45].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
			...
			if nil != me[i51] {
				{
					...
					var e error
					var sl []byte
					sl, e = me[i51].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
...
func (me *SrcIntels) preview_MarshalJSON() (r []byte, err error) {
	...
	if me == nil {
		...
		if len(me.InfoTips) != 0 {
			...
			r = append(r, 91)
			ai55 := len(r)
			for i54 := range me.InfoTips {
				{
					r = append(r, 44)
					var e error
					var sl []byte
					sl, e = me.InfoTips[i54].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
...
func (me *SrcIntelSigHelp) preview_MarshalJSON() (r []byte, err error) {
	...
	if me == nil {
		...
		if len(me.Signatures) != 0 {
			...
			r = append(r, 91)
			ai59 := len(r)
			for i58 := range me.Signatures {
				{
					r = append(r, 44)
					var e error
					var sl []byte
					sl, e = me.Signatures[i58].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
			...
			r = append(r, 93)
			if r[ai59] == 44 {
				r = append(r[:ai59], r[(ai59+1):]...)
			}
		}
		r = append(r, 125)
		if r[si57] == 44 {
			r = append(r[:si57], r[(si57+1):]...)
		}
	}
	return
}
...
func (me *SrcIntelSigInfo) preview_MarshalJSON() (r []byte, err error) {
	...
	if me == nil {
		...
		if nil == me.Parameters {
			...
			r = append(r, 91)
			ai62 := len(r)
			for i61 := range me.Parameters {
				{
					r = append(r, 44)
					var e error
					var sl []byte
					sl, e = me.Parameters[i61].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
			...
			r = append(r, 93)
			if r[ai62] == 44 {
				r = append(r[:ai62], r[(ai62+1):]...)
			}
		}
		r = append(r, 125)
		if r[si60] == 44 {
			r = append(r[:si60], r[(si60+1):]...)
		}
	}
	return
}
			...
			if nil != me[i64] {
				{
					...
					var e error
					var sl []byte
					sl, e = me[i64].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
			...
			if nil != me[i68] {
				{
					...
					var e error
					var sl []byte
					sl, e = me[i68].preview_MarshalJSON()
					if e == nil {
						r = append(r, sl...)
					} else {
						err = e
		...
		for i71 := range me {
			{
				...
				var e error
				var sl []byte
				sl, e = me[i71].preview_MarshalJSON()
				if e == nil {
					r = append(r, sl...)
				} else {
					err = e
